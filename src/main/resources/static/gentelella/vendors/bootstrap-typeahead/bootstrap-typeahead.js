...
!function ($) {
    ...
    Typeahead.prototype = {
        ...
        ajaxLookup: function (data) { 
            ...
            this.ajax.xhr = null;
            this.nowCount = items.length;
            if(items.length > 20){
            	return this.render(items.slice(0, this.options.items)).showMore();
            }
        ...
        show: function () {
            ...
            this.nowCount = this.nowCount > this.options.items ? this.options.items : this.nowCount;
            var height = 10 + this.nowCount * 26;
            this.$menu.css({
        ...
        render: function (items) {
            ...
            this.nowHeight = this.$menu.height();
            return this;
        },
